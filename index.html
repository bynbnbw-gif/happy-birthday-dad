...
<head>
    ...
    <!-- כל הלוגיקה והאתחול מאוחדים בבלוק זה כדי למנוע שגיאות ייבוא/גישה -->
    <script type="module">
        ...
        async function initFirebase() {
            try {
                ...
                errorEl.textContent = 'שגיאת התחברות למערכת. נסה לרענן.';
        ...
        function listenForBlessings() {
            ...
            onSnapshot(q, (snapshot) => {
                ...
                // הסרת הודעת הטעינה לאחר שהנתונים מתחילים להיטען בפעם הראשונה
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // הפעלת אתחול Firebase לאחר טעינת ה-DOM
            initFirebase();
        });
        ...
        if (blessingForm) {
            blessingForm.addEventListener('submit', async function(event) {
                ...
                const blessingData = {
                    ...
                    // משתמשים ישירות ב-serverTimestamp המיובא למעלה
